...
import NotLoggedIn from "../components/ui-components/utility-components/notLoggedIn";
...
export default function SubmitRecipe() {
  ...
  function updateFirst() {
    if (session) {
      setUserFirst(session?.user.name.split(" "));
    } else setUserFirst("");
  }
  ...
  const addRecipeToDB = async (e) => {
    try {
      ...
      if (response.ok) {
        ...
        form2Ref.current.reset();
        form3Ref.current.reset();
            ...
            <>
              <div className={styles.submitText}>
                ...
                <h2 className={styles.submitTextSubTitle}>
                  Got something tasty you want to share with the homechef
                  community?
                </h2>
                <p className={styles.importantInfo}>
                  Please make sure you fill out this form correctly or your
                  recipe will be rejected, all fields are required to be filled
                  out
                </p>
              </div>
              <div className={styles.formContainer}>
                <div className={styles.formArea}>
                  ...
                  <form ref={form1Ref} id="submitForm1">
                    ...
                    ></textarea>
                    <label className={styles.submitFormLabel}>
                      Ingredients - split with a semicolon (eg salt; pepper;
                      cheese)
                    </label>
                    <textarea
                      className={styles.submitFormTextarea}
                ...
                <div className={styles.formArea}>
                  ...
                  <form ref={form2Ref} id="submitForm2">
                    ...
                    >
                      Method - split each stage with a semicolon ( ; )
                    </label>
                    <textarea
                      className={styles.submitFormTextarea}
                      name="method"
                ...
                {!checkedRecipe && (
                  <>
                    <p className={styles.submitLabelText}>
                      Please carefully check all of the information you have
                      entered is correct. If it is, confirm this by clicking the
                      button and then submit it for review. Thanks!
                    </p>
                    <button
